...
As part of the WDI programme, Our first project requirement was to build an in-browser game using HTML, CSS, JavaScript and  JQuery Libary. Utilising skills learnt during the first couple of weeks of the course.

<hr>

##### Planning and Concept:

For my first project my inspiration came from the modern mouse maze game I played on the apple store and also my two cats who love catching mice.
...
Mouse Maze idea was taken from multiple maze games my favourite cartoon characters but also my imagination.
...
- The treats can be picked up by Tom where a point will be added to the cheese scoreboard.
- The traps are picked up by Tom where life will be lost making it closer to the game over.
...
- I need to further develop on how the computer automatically moves the cats they currently do not move as should (i.e. in a straight line)
